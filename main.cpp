...
int main() {
    ...
    try {
        ...
        // Add edges (for a simple undirected graph)
        ...
        // Demonstrate error handling for an invalid source vertex
        std::cout << "\nTesting error handling - invalid source vertex:" << std::endl;
        try {
            graph::Algorithms::bfs(g, 10);  // Trying to start BFS from a non-existing vertex
